import {
  ...
  this.props.navigation.navigate('Report',{user:this.state.username,id:this.state.id});
     }
...
<View style={styles.m}>
  ...
  <Button style={styles.mm} title="Send Friend Request" onPress={() => this.sendfriendrequest()}>
      
        </Button>
        <Button style={styles.mm} title="Report User" onPress={() => this.reportuser()}>
      
        </Button>
              <Button style={styles.mm} title="Block User" onPress={() => this.blockuser()}>
